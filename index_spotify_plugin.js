...
ControllerSpop.prototype.spotifyClientCredentialsGrant=function()
{
	...
	var refreshToken = 'AQAHo0fWvaC6RE3VkqZJPaFZ8i7gUKvY8XXxYE1FTzWgXbfD0r4Y1SsfktNFQE2TWoZ20v4RQCuIc0WaljXHATsnOEdKIChgQPSVJwLkqK7CmPc-lTXpaAd06WpP8DRsLf4wzw';
...
ControllerSpop.prototype.getMyPlaylists=function(curUri)
{
    ...
    var self=this;
self.logger.info('loading my plays QQQQ');
    var defer=libQ.defer();
